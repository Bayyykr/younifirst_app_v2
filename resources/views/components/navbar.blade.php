<div class="fixed top-6 left-0 right-0 z-50 px-4">
    <nav class="max-w-6xl mx-auto bg-white/95 backdrop-blur-md rounded-full shadow-md border border-gray-100 px-8 py-2 flex items-center justify-between">
        <!-- Logo Section -->
        <div class="flex items-center space-x-3 shrink-0">
            <img src="{{ asset('images/logo.png') }}" alt="Younifirst Logo" class="w-8 h-8 object-contain">
            <span class="text-[18px] font-extrabold tracking-tight text-[#1B1B18]">Younifirst</span>
        </div>
        ...
        <div class="flex items-center space-x-3 shrink-0">
            ...
            <a href="#" class="flex items-center px-6 py-2.5 text-[14px] font-bold text-white bg-[#0A3EBA] rounded-full hover:bg-[#344ed4] transition-all shadow-xl shadow-blue-500/10 whitespace-nowrap">
